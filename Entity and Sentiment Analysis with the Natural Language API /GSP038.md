...
## ☁️ Cloud IAM: Qwik Start | [GSP064](https://www.cloudskillsboost.google/games/6314/labs/39904)
...
```bash
curl -LO raw.githubusercontent.com/techloop-tamil/Arcade_lab_solution/refs/heads/main/Entity%20and%20Sentiment%20Analysis%20with%20the%20Natural%20Language%20API%20/Techloop_Tamil038.sh
sudo chmod +x Techloop_Tamil038.sh
./Techloop_Tamil038.sh
```
