...
```bash
curl -LO https://raw.githubusercontent.com/techloop-tamil/Arcade_lab_solution/refs/heads/main/Hello%20Node%20Kubernetes/Techloop_Tamil005.sh
sudo chmod +x Techloop_Tamil005.sh
./Techloop_Tamil005.sh
```
