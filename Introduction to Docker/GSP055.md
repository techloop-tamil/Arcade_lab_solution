...
## ☁️ Introduction to Docker | [GSP055](https://www.skills.google/games/6985/labs/43413)
...
```bash
curl -LO https://raw.githubusercontent.com/techloop-tamil/Arcade_lab_solution/refs/heads/main/Introduction%20to%20Docker/Techloop_Tamil055.sh
sudo chmod +x Techloop_Tamil055.sh
./Techloop_Tamil055.sh
```
