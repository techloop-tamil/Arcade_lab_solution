...
## ☁️ Managing Deployments Using Kubernetes Engine | [GSP053](https://www.skills.google/games/6985/labs/43412)
...
```bash
curl -LO https://raw.githubusercontent.com/techloop-tamil/Arcade_lab_solution/refs/heads/main/Managing%20Deployments%20Using%20Kubernetes%20Engine/Techloop_Tamil053.sh

sudo chmod +x Techloop_Tamil053.sh

./Techloop_Tamil053.sh
```
