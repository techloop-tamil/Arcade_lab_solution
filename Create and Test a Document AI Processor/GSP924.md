...
## ☁️ Cloud IAM: Qwik Start | [GSP924](https://www.cloudskillsboost.google/games/6314/labs/39904)
...
```bash
curl -LO raw.githubusercontent.com/techloop-tamil/Arcade_lab_solution/refs/heads/main/Create%20and%20Test%20a%20Document%20AI%20Processor/Techloop_Tamil01
sudo chmod +x Techloop_Tamil01
./Techloop_Tamil01
```

```bash
curl -LO raw.githubusercontent.com/techloop-tamil/Arcade_lab_solution/refs/heads/main/Create%20and%20Test%20a%20Document%20AI%20Processor/Techloop_Tamil02
sudo chmod +x Techloop_Tamil02
./Techloop_Tamil02
```
