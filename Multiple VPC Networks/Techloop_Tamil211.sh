...
# Expertly crafted by Adhithya - Teachloop Tamil
...
echo "${BG_BLUE}${BOLD}${WHITE}  WELCOME TO Techloop Tamil      ${RESET}"
echo "${BG_BLUE}${BOLD}${WHITE}============================================${RESET}"
echo ""
echo "${CYAN}${BOLD}⚡ Expertly crafted by Adhithya - Techloop Tamil ${RESET}"
echo "${YELLOW}${BOLD}📺 YouTube: ${UNDERLINE}http://www.youtube.com/@Techloop_Tamil${RESET}"
echo ""
...
echo -e "\n" "${GREEN}${BOLD}🔔 Don't forget to subscribe for daily cloud tutorials!${RESET}"
